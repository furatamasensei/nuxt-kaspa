...
import type { IFinalityConflict } from '../../../../src/runtime/types'

const data = ref<IFinalityConflict[]>([])
const id = ref(0)

const { start, stop } = useSubscribeFinalityConflict((event) => {
...
const code = `<script setup lang="ts">
  import type { IFinalityConflict } from '@nuxtjs/kaspa'
