...
import type { IVirtualChainChanged } from '../../../../src/runtime/types'

const data = ref<IVirtualChainChanged[]>([])
const id = ref(0)

const { start, stop } = useSubscribeVirtualChainChanged({
...
const code = `<script setup lang="ts">
  import type { IVirtualChainChanged } from '@nuxtjs/kaspa'
