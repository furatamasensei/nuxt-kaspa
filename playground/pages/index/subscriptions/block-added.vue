...
import type { IBlockAdded } from '../../../../src/runtime/types'

const data = ref<IBlockAdded[]>([])
const id = ref(0)

const { start, stop } = useSubscribeBlockAdded((event) => {
...
const code = `<script setup lang="ts">
  import type { IBlockAdded } from '@nuxtjs/kaspa'
