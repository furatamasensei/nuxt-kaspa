...
import type { ISinkBlueScoreChanged } from '../../../../src/runtime/types'

const data = ref<ISinkBlueScoreChanged[]>([])
const id = ref(0)

const { start, stop } = useSubscribeSinkBlueScoreChanged((event) => {
...
const code = `<script setup lang="ts">
  import type { ISinkBlueScoreChanged } from '@nuxtjs/kaspa'
